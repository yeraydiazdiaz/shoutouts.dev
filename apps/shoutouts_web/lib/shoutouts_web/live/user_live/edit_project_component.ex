defmodule ShoutoutsWeb.UserLive.EditProjectComponent do
  ...
  @impl true
  def handle_event("validate", %{"project" => project_params}, %{assigns: %{project: project}} = socket) do
    changeset = Projects.change_project(project, project_params)
    {:noreply, assign(socket, :changeset, changeset)}
  end

  def handle_event("save", %{"project" => project_params}, %{assigns: %{project: project}} = socket) do
